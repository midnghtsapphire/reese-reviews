...
export const DEFAULT_PERSONS: TaxPerson[] = [
  // ── Caresse — PRIMARY (this is her app) ──────────────────────
  {
    ...
    notes: "Primary user of this app. Full-time caregiver for Audrey/Mom AND digital business manager for all of Audrey's sites & ventures. Also co-owns Rocky Mountain Rentals (20%). Three income streams: (1) home care, (2) site/business management, (3) rental income (20% share — Schedule E).",
